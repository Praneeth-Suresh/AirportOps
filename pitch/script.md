...
> "Hi, I'm [name]. This is my team. We built a real-time 3D dashboard for airport operations — the entire terminal in one live view."
...
**Show:** Simple layered diagram — Sensing → Data → AI.
...
> "To wrap up — our real-time 3D airport operations system delivers three things. One: total live visibility — the whole terminal in a single view. Two: foresight — spot bottlenecks before they form, and act early. Three: AI on watch — Otto AI catches what humans miss."
